...
A token us used to authenticate a user give them the correct login credentials.

- [ ] What steps can you take in your web apps to keep your data secure?

You can add PrivateRoutes.

- [ ] Describe how web servers work.

Web servers are a program that use HTTP that let you request and send information to HTTP clients.
